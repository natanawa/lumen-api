...
class Checklist extends Model
{
    ...
    protected $fillable = [
        'template_id','object_domain','object_id','description','is_completed','completed_at','due','due_interval','due_unit','urgency','created_by','updated_by','created_at','updated_at'
    ];
